		...
		<center>
			...
			<div id="u-9" class="tab-pane active">
				<div class="c-content-tab-3 c-opt-1" role="tabpanel">
					<ul class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
                      ...
                      <li style="margin-right: 15px;">
                        ...
                        <a href="#u9-final" role="tab" data-toggle="tab" class="c-font-16 c-font-uppercase btn btn-sm btn-primary mb-3 active" aria-expanded="false" style="border-radius: 60px; width: 80px;">Final</a>
				...
				<div class="tab-content table-responsive">
					<div class="tab-pane " role="tabpanel" id="u9-1">
						<div class="c-content-tab-3 c-opt-1" role="tabpanel">
						    <div class="text-left">
        				    <br>
				            <h2>U9 Grup A</h2>
...
<!--					</div>-->
			...
			<div id="u-11" class="tab-pane">
				<div class="c-content-tab-3 c-opt-1" role="tabpanel">
					<ul  class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
                      ...
                      <li style="margin-right: 15px;">
                        ...
                        <a href="#u11-final" role="tab" data-toggle="tab" class="active c-font-16 c-font-uppercase btn btn-sm btn-primary mb-3" aria-expanded="false" style="border-radius: 60px; width: 80px;">Final</a>
				...
				<br>
				<div class="tab-content table-responsive">
					<div class="tab-pane " role="tabpanel" id="u11-1">
						<div class="c-content-tab-3 c-opt-1" role="tabpanel">
						    <div class="text-left">
				            <h2>U11 Grup A</h2>
				            </div>
...
@endforeach
					...
					<div class="tab-pane active"  role="tabpanel" id="u11-final">
						<div class="c-content-tab-3 c-opt-1" role="tabpanel">
						    <div class="text-left">
				            <h2>U11 Final</h2>
				            </div>
...
<!--					</div>-->
			...
			<div id="u-13" class="tab-pane">
				<div class="c-content-tab-3 c-opt-1" role="tabpanel">
					<ul class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
                      ...
                      <li style="margin-right: 15px;">
                        ...
                        <a href="#u13-final" role="tab" data-toggle="tab" class="active c-font-16 c-font-uppercase btn btn-sm btn-primary mb-3" aria-expanded="false" style="border-radius: 60px; width: 80px;">Final</a>
				...
				<br>
				<div class="tab-content table-responsive">
					<div class="tab-pane " role="tabpanel" id="u13-a">
						<div class="c-content-tab-3 c-opt-1" role="tabpanel">
						    <div class="text-left">
				            <h2>U13 Grup A</h2>
				            </div>
...
@endforeach
					...
					<div class="tab-pane active"  role="tabpanel" id="u13-final">
						<div class="c-content-tab-3 c-opt-1" role="tabpanel">
						    <div class="text-left">
				            <h2>U13 Final</h2>
				            </div>
