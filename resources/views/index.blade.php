            ...
            <div class="dark">
                ...
                <div class="center">
                    ...
                    <div style="top: 50vh; position: absolute;" class="container text-center">
                        ...
                        <a style="color: white;" class="page-scroll" href="#pertandingan"><i class="fa-2x fas faa-bounce animated fa-chevron-down"></i></a>
  ...
  <div class="container">
    <div class="row" style="margin-top: 80px;">
      <div class="col-sm-12 mb-4">
        ...
        <h3 class="text-center text-uppercase">Peringkat</h3>
            ...
            <div class="tab-content">
              <div role="tabpanel" class="tab-pane active" id="u-9">
                  <div id="div-tab" class="c-content-tab-3 c-opt-1" role="tabpanel">
                    <ul class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
                      <li style="margin-right: 15px; margin-left:30px;">
                  ...
                  <div id="div-tab" class="c-content-tab-3 c-opt-1" role="tabpanel">
                    <ul class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
                      <li style="margin-right: 15px; margin-left:15px;">
                        <a href="#u11-1" role="tab" data-toggle="tab" class="c-font-16 c-font-uppercase btn btn-sm btn-primary mb-3 active" aria-expanded="true" style="border-radius: 60px; width: 80px;">Grup A</a>
                      </li>
                      <li style="margin-right: 15px;">
                  ...
                  <div id="div-tab" class="c-content-tab-3 c-opt-1" role="tabpanel">
                    ...
                    <ul class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
                      ...
                      <li style="">
                        ...
                        <a href="#u13-1" role="tab" data-toggle="tab" class="c-font-16 c-font-uppercase btn btn-sm btn-primary mb-3 active" aria-expanded="true" style="border-radius: 60px; width: 80px;">Grup A</a>
                      </li>
                      <!--<li style="margin-right: 15px;">-->
...
<!--jadwal-->
<section id="jadwal_final" style="background-color: #1f2861 !important" class="text-light">
    <div class="container" >
            <div class="c-content-title-1">
    			<center><br><br>
    				<h1 >Jadwal Pertandingan Final</h1>
		    ...
		    <div class="c-content-tab-3 c-opt-1" role="tabpanel">
		        <ul class="nav nav-tabs c-font-uppercase c-font-bold c-margin-b-10 justify-content-center" role="tablist" style="border: none;">
                  ...
                  <li class="active">
                    ...
                    <a href="#u9-final" role="tab" data-toggle="tab" class="c-font-16 c-font-uppercase btn btn-sm btn-light mb-3 active" aria-expanded="true" style="border-radius: 60px; width: 50px; margin-right: 15px;">U9</a>
    
                    <a href="#u11-final" role="tab" data-toggle="tab" class="c-font-16 c-font-uppercase btn btn-sm btn-light mb-3" aria-expanded="true" onclick="showall(); showcat(1);" style="border-radius: 60px; width: 50px; margin-right: 15px;">U11</a>
    
                    <a href="#u13-final" role="tab" data-toggle="tab" class="c-font-16 c-font-uppercase btn btn-sm btn-light mb-3" aria-expanded="true" onclick="showall(); showcat(1);" style="border-radius: 60px; width: 50px;">U13</a>
    
                  </li>
    
                </ul>
		    </div>
		    <div class="tab-content table-responsive text-light">
    		    <div class="tab-pane active"  role="tabpanel" id="u9-final">
    				<div class="c-content-tab-3 c-opt-1" role="tabpanel">
    				    <div class="text-left">
    		            <h2>U9 Final</h2>
    		            </div>
...
<!-- jadwal -->
<!-- <section id="match" style="background-color: #1f2861 !important">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-sm-6 mb-4" style="margin-top: 80px;">
                <center>
@php 
  $i=1;
...
@foreach($jadwalDOWN as $a)
  @if($i<2)

    @if($a->tanggal." ".$a->jam <= date("Y-m-d H.i"))
      @php $i++; @endphp
                    <h3 class="text-uppercase text-white">Pertandingan Sebelumnya</h3>
                    <hr style="width: 50px; border: 2px solid white;">
                    <h6 class="text-uppercase text-white">{{date("l, d F Y"), strtotime($a->tanggal)}} ({{$a->jam}})</h6>
			    ...
			    @endforeach
                    ...
                    <h6 class="text-uppercase text-white">VS</h6>
                    <h6 class="text-uppercase text-white">
  ...
  @else
      <!-- <h3 class="text-uppercase text-white">Pertandingan Sebelumnya</h3>
                      <hr style="width: 50px; border: 2px solid white;">
                      <br>
                      <h4 class="text-uppercase text-white">Tidak ada Pertandingan</h4> --> <!--
  @endif
...
@foreach($jadwalUP as $a)
  @if($z<2)

    @if($a->tanggal." ".$a->jam >= date("Y-m-d H.i"))
      @php $z++; @endphp
                    <h3 class="text-uppercase text-white">Pertandingan Selanjutnya</h3>
                    <hr style="width: 50px; border: 2px solid white;">
                    <h6 class="text-uppercase text-white">{{date("l, d F Y", strtotime($a->tanggal))}} ({{$a->jam}})</h6>
                    <h6 class="text-uppercase text-white">
                        			    @foreach($teams as $t)
...
<!--						  <div class="card" style="border: none;">-->
						    ...
						    <!-- Card header -->
<!--						    <div class="card-header" role="tab" id="headingOne1" style="background-color: #fff; border: none;">-->
<!--						      <a class="btn-acc" data-toggle="collapse" data-parent="#accordionEx" href="#collapseOne1" aria-expanded="false"-->
...
<!--						  <div class="card" style="border: none;">-->
						    ...
						    <!-- Card header -->
<!--						    <div class="card-header active" role="tab" id="headingTwo2" style="border: none; background-color: #fff;">-->
        ...
        <div class="row justify-content-center">
            ...
            <div class="carousel">
                ...
                <div class="carousel-row">
                      ...
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (1).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (1).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (2).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (2).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (3).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (3).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (4).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (4).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (5).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (5).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (6).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (6).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (7).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (7).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/tim (8).jpeg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/tim (8).jpeg" style="width: 90%;" ></a></div>
                      
                      <div class="carousel-tile"><a href="{{asset('compressjpeg')}}/6.jpg" data-lightbox="Laptop1"><img src="{{asset('compressjpeg')}}/6.jpg" style="width: 90%;" ></a></div>
...
<section id="maps">
	<div class="container">
		<div class="row">
            <div class="col-sm-12 mb-4" style="margin-top: -10px;">
	...
	<div class="container-fluid"  style="margin-top: 80px;">
		<div class="row">
			<div class="col-md-12 text-center mb-5">
				...
				<img src="https://telesandifestival.com/images/partner/1568280116.png" style="width: 300px;">
				<img src="http://smktelkom-pwt.sch.id/wp-content/uploads/2018/10/logo-it-telkom-purwokerto.jpg" style="width: 300px;">
				<img src="https://upload.wikimedia.org/wikipedia/id/f/ff/Toyota_Let%27s_Go_Beyond.svg" style="width: 300px;">
				<img src="https://cdn-kisikisi.qerja.com/assets/companies/images/logo/sinde_budi_sentosa_pt.png" style="margin: 30px;width: 100px;">
			</div>
		</div>
	</div>
	<div class="container mb-5">
...
<!--				<img src="https://peoplepng.com/wp-content/uploads/2019/04/logo-telkomsel-terbaru-png-4.png" style="width: 300px;" class="mb-4">-->
				<!--<img src="http://smktelkom-pwt.sch.id/wp-content/uploads/2018/10/logo-it-telkom-purwokerto.jpg" style="width: 300px;" class="mb-4">-->
				<!--<img src="https://upload.wikimedia.org/wikipedia/id/f/ff/Toyota_Let%27s_Go_Beyond.svg" style="width: 300px;">-->
<!--			</div>-->
<!--			<div class="col-md-6 text-center">-->
<!--                <h3 class="text-center text-uppercase">Media Partner</h3>-->
<!--                <hr style="width: 50px; border: 2px solid #1f2861;">-->
<!--				<img style="width: 130px;" src="http://telsfest.syntx.id/images/partner/1567410142.jpg">-->
<!--				<img style="width: 100px;" src="http://telsfest.syntx.id/images/partner/1567876914.jpeg"><br>-->
<!--				<img style="width: 200px;" src="https://telesandifestival.com/images/partner/1568806884.jpg">-->
<!--			</div>-->
<!--</section>-->
    ...
    <footer class="bg-dark" style="background-color: #3a3a3a !important; padding: 25px 0px 0px 0px;">
      ...
      <p style="background-color: #2b2b2b !important; color: #fff; padding: 15px; margin: 0;" class="text-center">&copy; 2019 <a href="/" style="color: #fff; text-decoration: none;">Telesandi Football Cup</a>. All rights reserved. Development by <a href="https://syntx.id/">Syntax Telesandi</a></p>
