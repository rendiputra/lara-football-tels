        ...
        <table class="table bg-white">
          <tbody>
            <tr>
              ...
              <td style="font-size: 1.33rem">{{ $data->nama_teams}}
              
    <a href="https://telesandifootballcup.com/edit_team/{{ $data->id_teams }}" class="btn btn-sm btn-warning text-center">Edit Profil Tim</a>
              </td>
            </tr>
            <tr>
    ...
    <div class="row justify-content-center">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <a href="https://telesandifootballcup.com/user/dash" class="btn btn-primary mb-3">Kembali</a>
...
@foreach($data2 as $m)
                            <tr>
                                ...
                                <td>{{ $m->nisn }}</td>
                                <td><a class="btn btn-sm btn-warning" href="/user/data_player/edit/{{ $m->id_players }}">Edit</a></td>
                            </tr>
@endforeach                            
                                ...
                                <tr>
                                    ...
                                    <td><a class="btn btn-sm btn-primary" href="/user/insert_player/{{ $data->id_teams }}">Tambah</a>
                                    @if(Auth::user()->isAdmin == TRUE)
                                    <a class="btn btn-sm btn-primary" href="/admin/insert_player/{{ $data->id_teams }}">Tambah 2</a>
                                    @endif
                                    </td>
